...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If activePlayer is equal to 'X', the x.png is selected in the HTML.
...
//This function parses the selectedSquares array to search for any win conditions.
//drawWinLine funciton is called to draw line if condition is met.
...
//This function utilizes html canvasto draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        //This line indivates where the start of a lines y axis is.
        y1= coordY1,
